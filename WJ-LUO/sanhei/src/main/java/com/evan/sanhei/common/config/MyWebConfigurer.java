...
public class MyWebConfigurer implements WebMvcConfigurer {
    ...
    //将URL 的前缀跟我们设置的图片资源文件夹，即 f:/svndownloads/wj-luo/wj-vue/src/coverimg 对应起来。
    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/WJ-LUO/file/**").addResourceLocations("file:" + "f:/svndownloads/wj-luo/wj-vue/src/coverimg/");
    }
}
